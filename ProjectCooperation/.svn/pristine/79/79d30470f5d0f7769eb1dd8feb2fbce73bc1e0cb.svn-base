...
var App = (function(){
    ...
    var run = function(){
        ...
        Jingle.launch({
            ...
            remotePage : {
            	'#index_section': ctx,
            	'#userList_section': ctx + '/sys/user/list',
            	'#userIndex_section': ctx + '/sys/user/index',
            	'#userForm_section': ctx + '/sys/user/form',
            	'#task_detalis_section':ctx + '/task/wx/detail',
            	'#mytask_section':ctx + '/task/wx/mytask'
            }
        });

    ...
    <div class="form-group">
      <label  class="col-sm-2 control-label name">部门</label>
		<div class="col-sm-9 dropdown-div">
        	...
        	<span class="add-members" data-toggle="modal" title="选择部门" data-target="#Add-Department" href="${ctxSurfond}/organizational/template/Add-Department.html"  data-dismiss="modal" aria-label="Close">+</span>
      	</div>
      </div>
    </div>
  </form>

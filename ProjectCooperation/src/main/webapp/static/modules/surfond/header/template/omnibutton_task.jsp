...
<div class="modal-body">
  <form class="form-horizontal" id="newSpaceTaskForm" target="_top" method="post">
    <input type="hidden" name="spaceId" value="${checkedSpace.id }">
    <div class="form-group">
      <label  class="col-sm-2 control-label name">任务名字</label>
      <div class="col-sm-10">
   ...
   <div class="form-group">
	 ...
	 <div class="botton col-sm-8">
		 ...
		 <button  class="btn-orange" id="newSpaceTaskBtn">保存</button>

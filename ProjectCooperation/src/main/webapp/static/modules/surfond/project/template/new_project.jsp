...
<div class="modal-body">
  <form id="newProjectForm" class="form-horizontal" target="_top" method="post">
    <div class="form-group">
      <label  class="col-sm-2 control-label name">项目标题</label>
      <div class="col-sm-10">
   ...
   <div class="form-group">
	 ...
	 <div class="botton col-sm-8">
		 ...
		 <button  class="btn-orange" id="newProjectBtn">保存</button>
